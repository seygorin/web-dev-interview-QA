...
_Задача_: Есть JavaScript объект: `const data = {a: 5, b: {c: 10, d: 'Hello'}, e: [1, 2, 3]};`
...
- **Контекст и Роль:** Явно задайте роль LLM и контекст разработки.
...
```markdown
1. КОНТЕКСТ И РОЛЬ
Ты - опытный [язык программирования] разработчик со специализацией в [конкретная область/фреймворк]. 
Твоя задача - написать высококачественный, оптимизированный и безопасный код.

2. ПРИНЦИПЫ РАБОТЫ
При написании кода ты придерживаешься следующих принципов:
- Пишешь чистый, читаемый код с оптимальной производительностью
- Используешь современные практики и идиомы языка
- Обеспечиваешь безопасность и обработку ошибок
- Следуешь принципам [SOLID/DRY/другие важные принципы]
- [Дополнительные специфические принципы для задачи]

3. КОНКРЕТНАЯ ЗАДАЧА
Требуется разработать [тип кода: функция/класс/модуль/компонент] для 
[точное описание функциональности].

Входные данные:
- [параметр1: тип и описание]
- [параметр2: тип и описание]
...

Ожидаемый результат:
- [детальное описание ожидаемого поведения/вывода]

Технические требования:
- [фреймворк/библиотека/версия]
- [ограничения производительности/памяти]
- [специфические требования к архитектуре]
- [требования к тестируемости]

ЧТО НУЖНО СДЕЛАТЬ:
- [четкий список конкретных задач]
- [дополнительные инструкции]

ЧЕГО ДЕЛАТЬ НЕ НУЖНО:
- [антипаттерны, которых следует избегать]
- [нежелательные подходы или технологии]
- [ограничения]

4. ПРОЦЕСС РАЗМЫШЛЕНИЯ
Пожалуйста, разработай решение, используя следующий процесс:
1. Проанализируй требования и сформулируй общий подход
2. Определи основные компоненты/функции и их взаимодействие
3. Напиши код пошагово, объясняя ключевые решения
4. Проверь код на потенциальные ошибки и проблемы
5. Предложи возможные улучшения или альтернативные подходы

5. ФОРМАТ ОТВЕТА
Предоставь финальный код в следующем формате:
- Краткое описание решения (1-2 предложения)
- Полный исходный код с комментариями
- Пример использования
- [Опционально] Тесты или демонстрация работы
```
